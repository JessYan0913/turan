...
export function ImageGenerationTab() {
  ...
  return (
    <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
      <Form {...form}>
        <form
          className="rounded-2xl bg-gradient-to-br from-white to-amber-50/30 p-6 shadow-sm ring-1 ring-black/5 transition-all duration-300 dark:from-gray-900 dark:to-amber-950/20 dark:ring-white/10"
