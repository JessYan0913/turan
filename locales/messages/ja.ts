    ...
    'style-transfer-info': {
      ...
      list: {
        ...
        items: [
          {
            title: '多様な専門モデル',
            description: 'Flux Redux AI や Flux.1 Dev など、用途に応じて最適化されたさまざまなモデルから選択できます。',
          },
          {
            title: 'スマートなモデル選定',
            description:
              '入力画像とテキストに基づいて、システムが最適なモデルを自動的に選定し、品質とコストを両立します。',
          },
          {
            title: '高精度なテキスト理解',
            description:
              '高度な自然言語処理により、テキストプロンプトを正確に解釈し、意図どおりの変換が可能になります。',
          },
          {
            title: 'コスト効率の良い処理',
            description: 'タスクに応じて軽量モデルと高機能モデルを使い分けることで、品質とコストを最適化できます。',
          },
        ],
      },
    },
