        ...
        items: [
          {
            title: '图像驱动的风格创作',
            description:
              '无需编写复杂的提示词。只需上传您的内容图片和一张风格参考图，AI 即可自动捕捉风格精髓，并将其完美融合。',
          },
          {
            title: '精准风格捕捉',
            description: 'AI 不仅学习风格图片的色彩和笔触，更能理解其构图与氛围，同时精准保留您原始照片的内容和细节。',
          },
          {
            title: '无限创意可能',
            description: '从梵高的油画到赛博朋克的霓虹，任何图片都可以成为您的风格来源，轻松创造出独一无二的艺术作品。',
          },
          {
            title: '零提示词的即时创作',
            description:
              '告别反复调试提示词的烦恼。通过直观的图片选择，您可以即时预览和生成结果，整个创作过程更加流畅、高效。',
          },
        ],
      },
    },
